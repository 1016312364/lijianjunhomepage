             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile">
								<h1><a href="index.html">集中资源</a></h1>
							</div>
...
<h3>统计数据</h3>
	<div class="toolbar">
		<div class="pull-left">
			<div class="btn-group">
				<a href="#" class="btn btn-default btn-xs">日刊</a>
				<a href="#" class="btn btn-default btn-xs active">月刊</a>
				<a href="#" class="btn btn-default btn-xs">年刊</a>
			</div>
		</div>
		<div class="pull-right">
			<div class="btn-group">
			  <a aria-expanded="false" class="btn btn-default btn-xs dropdown-toggle" data-toggle="dropdown">导出<i class="fa fa-angle-down"></i></a>
			  <ul class="dropdown-menu pull-right" role="menu">
				<li><a href="#">导出为PDF</a></li>
				<li><a href="#">导出为CSV</a></li>
				<li><a href="#">导出为PNG</a></li>
				<li class="divider"></li>
				<li><a href="#">分离链接</a></li>
			  </ul>
			</div>
			...
			<div class="widget widget-report-table">
				...
				<div class="row m-0 md-bg-grey-100 p-l-20 p-r-20">
					...
					<div class="col-md-6 col-sm-6 col-xs-6 ">
						<h2 class="text-right c-teal f-300 m-t-20">1</h2>
					</div>
				</div>
			...
			<div class="list-group">
				<a class="list-group-item media" href="">
					...
					<div class="media-body">
						<div class="pull-left">
							<div class="lg-item-heading">17</div>
							<small class="lg-item-text">18</small>
						</div>
						<div class="pull-right">
							<div class="lg-item-heading">19</div>
						</div>
					</div>
				</a>
				<a class="list-group-item media" href="">
					...
					<div class="media-body">
						<div class="pull-left">
							<div class="lg-item-heading">20</div>
							<small class="lg-item-text">21</small>
						</div>
						<div class="pull-right">
							<div class="lg-item-heading">22</div>
						</div>
					</div>
				</a>
				<a class="list-group-item media" href="">
					...
					<div class="media-body">
						<div class="pull-left">
							<div class="lg-item-heading">23</div>
							<small class="lg-item-text">24</small>
						</div>
						<div class="pull-right">
							<div class="lg-item-heading">25</div>
						</div>
					</div>
				</a>
				<a class="list-group-item media" href="">
					...
					<div class="media-body">
						<div class="pull-left">
							<div class="lg-item-heading">26</div>
							<small class="lg-item-text">27</small>
						</div>
						<div class="pull-right">
							<div class="lg-item-heading">28</div>
						</div>
					</div>
				</a>
...
<div class="col-md-4 wthree-pan">
	<div class="panel panel-default">
	  <div class="panel-heading"> <i class="fa fa-bell fa-fw"></i>通知栏</div>
	  <!-- /.panel-heading -->
	  <div class="panel-body">
		<div class="list-group">
			<a href="#" class="list-group-item"> <i class="fa fa-comment fa-fw"></i>新评论<span class="pull-right text-muted small"><em>4 minutes ago</em> </span> </a>
			<a href="#" class="list-group-item"> <i class="fa fa-twitter fa-fw"></i>新粉丝<span class="pull-right text-muted small"><em>12 minutes ago</em> </span> </a>
			<a href="#" class="list-group-item"> <i class="fa fa-envelope fa-fw"></i>新消息<span class="pull-right text-muted small"><em>27 minutes ago</em> </span> </a>
			<a href="#" class="list-group-item"> <i class="fa fa-tasks fa-fw"></i>新任务<span class="pull-right text-muted small"><em>43 minutes ago</em> </span> </a>
			<a href="#" class="list-group-item"> <i class="fa fa-upload fa-fw"></i>服务器重启了<span class="pull-right text-muted small"><em>11:32 AM</em> </span> </a>
			<a href="#" class="list-group-item"> <i class="fa fa-bolt fa-fw"></i>服务器崩库了<span class="pull-right text-muted small"><em>11:13 AM</em> </span> </a>
			<a href="#" class="list-group-item"> <i class="fa fa-tasks fa-fw"></i>新任务<span class="pull-right text-muted small"><em>43 minutes ago</em> </span> </a>
		</div>
		<!-- /.list-group -->
				...
				<table class="table stats-table ">
					...
					<tbody>
						<tr>
							...
							<td><h5>46<i class="fa fa-level-up"></i></h5></td>
						</tr>
						<tr>
							<th scope="row">47</th>
							<td>48</td>
							<td><span class="label label-warning">49</span></td>
							<td><h5>50<i class="fa fa-level-up"></i></h5></td>
						</tr>
						<tr>
							<th scope="row">51</th>
							<td>52</td>
							<td><span class="label label-danger">53</span></td>
							<td><h5 class="down">54<i class="fa fa-level-down"></i></h5></td>
						</tr>
						<tr>
							<th scope="row">55</th>
							<td>56</td>
							<td><span class="label label-info">57</span></td>
							<td><h5>58<i class="fa fa-level-up"></i></h5></td>
						</tr>
						<tr>
							<th scope="row">59</th>
							<td>60</td>
							<td><span class="label label-success">61</span></td>
							<td><h5 class="down">62<i class="fa fa-level-down"></i></h5></td>
						</tr>
						<tr>
							<th scope="row">63</th>
							<td>64</td>
							<td><span class="label label-warning">65</span></td>
							<td><h5>66<i class="fa fa-level-up"></i></h5></td>
						</tr>
					</tbody>
				</table>
			</div>
